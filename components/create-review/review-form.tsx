	...
	return (
		...
		>
			...
			<Transition show={getStarted}>
				...
				>
					<div className='flex w-full flex-col gap-3 border-b-2 border-b-[#7e9860] p-4 transition-all duration-500'>
						<LandlordForm
			...
			<Transition show={showLocationForm}>
				<TransitionChild
					...
					leaveTo='transform scale-95 opacity-0 max-h-0'
				>
					<div className='w-full border-b-2 border-b-[#7e9860] p-4 transition-all duration-500'>
						<LocationForm
			...
			<Transition show={showRatingForm}>
				<TransitionChild
					...
					leaveTo='transform scale-95 opacity-0 max-h-0'
				>
					<div className='w-full overflow-hidden border-b-2 border-b-[#7e9860] p-4 transition-all duration-500'>
						<RatingForm
			...
			<Transition show={showPreview}>
				<TransitionChild
					...
					leaveTo='transform scale-95 opacity-0 max-h-0'
				>
					<div className='w-full overflow-hidden border-b-2 border-b-[#7e9860] p-4 py-4 transition-all duration-500'>
