	...
	return (
		<div data-testid='about-terms-1' className='w-full bg-white'>
			<div className='mx-auto flex max-w-7xl flex-col gap-2 px-6 text-lg lg:px-8'>
				...
				<p>
					We use a third-party analytics services, Umami analytics and PostHog,
					to help us understand how visitors interact with our website. This
					service collects information such as your IP address, browser type,
					...
					<br />
					Umami analytics may use cookies or other tracking technologies to
					collect and store this information. You can find more information
					about Umami analytics and their privacy practices on their website.
					<br />
					...
					by Umami analytics and PostHog in the manner and for the purposes set
					out above.
				</p>
