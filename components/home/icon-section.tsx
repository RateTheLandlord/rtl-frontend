						...
						<div className='mx-auto mt-12 grid max-w-sm grid-cols-1 gap-x-8 gap-y-10 sm:max-w-none lg:grid-cols-3'>
							<div className='text-center sm:flex sm:text-left lg:block lg:text-center'>
								<div className='flex justify-center sm:shrink-0'>
									<div className='flow-root'>
										<Privacy styling='className="w-16 h-16 mx-auto text-[#7e9860]' />
									</div>
								</div>
							...
							<div className='text-center sm:flex sm:text-left lg:block lg:text-center'>
								<div className='sm:shrink-0'>
									<div className='flow-root'>
										<Solidarity styling='className="w-16 h-16 mx-auto text-[#7e9860]' />
									</div>
								</div>
								<div className='mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0'>
									<h3 className='text-2xl text-gray-900'>
							...
							<div className='text-center sm:flex sm:text-left lg:block lg:text-center'>
								<div className='sm:shrink-0'>
									<div className='flow-root'>
										<Transparency styling='className="w-16 h-16 mx-auto text-[#7e9860]' />
									</div>
								</div>
								<div className='mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0'>
									<h3 className='text-2xl text-gray-900'>
