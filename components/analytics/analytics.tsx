	...
	const CustomTooltip = ({
		...
		if (active && payload && payload.length) {
			if (dataKey === 'trailing_combined_avg') {
				return (
					<div className='custom-tooltip rounded-lg border-4 border-[#7e9860] bg-gray-100'>
	...
	return (
		<div className='grid w-full grid-cols-1 gap-2 bg-gray-50 lg:grid-cols-[3fr_1fr]'>
			...
			<div className='flex-1 lg:w-[100%]'>
				...
				<div className='h-158 rounded-lg border-4 border-[#7e9860] bg-white lg:p-4'>
			...
			<div className='hidden lg:block lg:flex-1'>
				...
				<div
					className='h-[47%] rounded-lg border-4 border-[#7e9860] bg-white p-4 hover:cursor-pointer hover:opacity-70 hover:shadow-lg'
				...
				>
					...
					<div className='grid w-full grid-rows-3 gap-2'>
						<div className='flex h-16 flex-col items-center justify-center rounded-lg border border-[#7e9860] bg-[#7e9860]/5 text-lg'>
							<div>{t('last-90')}</div>
							<div>
								<RatingStars
						...
						<div className='flex flex-col items-center justify-center rounded-lg border border-[#7e9860] bg-[#7e9860]/5 text-lg'>
							<div>{t('last-180')}</div>
							<RatingStars
