...
const AnalyticsComponent = ({
	...
	const { data, error } = useSWR<AnalyticsResponse, Error>(
		[
			'/api/review/review-analytics',
			{ landlordFilter, stateFilter, countryFilter, cityFilter, zipFilter },
		],
		fetchWithBody,
	)
			...
			<div className='flex-1'>
				...
				<div className='border p-4'>
					...
					<div className='grid w-full grid-cols-3 border-b'>
						<div className='flex flex-col items-center justify-center border text-lg'>
