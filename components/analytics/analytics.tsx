...
import { AnalyticsChartResponse, AnalyticsResponse } from '@/lib/analytics/models/review'
	...
	return (
		<div className='grid w-full grid-cols-2 bg-gray-50'>
			...
			<div className='flex-1'>
				...
				<div className='border-4 rounded-lg border-teal-600 p-4 bg-white h-52'>
					<div className='bold flex items-center justify-center pb-12 pt-2 text-xl underline'>
						Total Reviews
					</div>
					<div className='grid w-full grid-cols-3 gap-2'>
						<div className='flex flex-col items-center justify-center border border-teal-600 rounded-lg text-lg bg-teal-600/5 h-16'>
						...
						<div className='flex flex-col items-center justify-center border border-teal-600 rounded-lg text-lg bg-teal-600/5'>
