		...
		>
			<div className='relative w-full pt-2 lg:px-2 lg:pt-2'>
				...
				<Transition
					...
					leaveTo='opacity-0'
				>
					<ComboboxOptions className='sm:text-md ring-opacity-5 absolute z-10 mt-1 max-h-60 w-9/12 overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black focus:outline-none sm:w-1/2 md:w-8/12 lg:w-9/12 xl:w-7/12 2xl:w-7/12'>
						...
						{({ selected }) => (
							<span
								className={`block truncate ${
									selected ? 'font-inclusive font-medium' : 'font-inclusive'
								}`}
							>
