		...
		<Listbox value={state} onChange={setState}>
			<div className='px-2'>
				...
				>
					<ListboxOptions
						anchor='bottom start'
						className='ring-opacity-5 absolute z-[999] mt-1 max-h-[250px] w-[250px] overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black focus:outline-none sm:text-sm'
					>
						{options.map((option) => (
							<Listbox.Option
								key={option.id}
