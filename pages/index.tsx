...
export default function Home(): JSX.Element {
  ...
  return (<div>
      <NextSeo
        ...
        canonical={pageURL}
        openGraph={{
          type: "website", locale: "en_CA", //  Default is en_US
          url: pageURL, title, description: desc,

          site_name: siteName
        }}
        twitter={{
          handle: twitterHandle, site: twitterHandle, cardType: "summary_large_image"
        }}
        additionalMetaTags={[{
          property: "author", content: title
        }]}
        additionalLinkTags={[{
